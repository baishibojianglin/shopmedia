<template>
	<div class="user_to_ad_edit">
		<el-card class="main-card">
			<div slot="header" class="clearfix">
				<el-row :gutter="20" type="flex" justify="space-between">
					<el-col :span="6"><span>编辑广告主业务员</span></el-col>
					<el-col :span="3">
...
<script>
	export default {
		...
		methods: {
			...
			getUser() {
				let self = this;
				this.$axios.get(this.$url + 'user_to_ad/' + this.form.user_id, {
					/* headers: {
			...
			submitForm(formName) {
				...
				this.$refs[formName].validate((valid) => {
					if (valid) {
						this.$axios.put(this.$url + 'user_to_ad/' + this.form.user_id, {
							// 参数
