		...
		<el-card class="main-card">
			<div slot="header" class="clearfix">
				<el-row :gutter="20" type="flex" justify="space-between">
					<el-col :span="6"><span>新增新闻</span></el-col>
					<el-col :span="3">
				...
				<el-form ref="ruleForm" :model="form" :rules="rules" label-width="200px" size="small" class="demo-form-inline">
					...
					<el-form-item prop="status" label="状态">
						<el-radio-group v-model="form.status">
							<el-radio v-for="(item, index) in {0: '草稿', 4: '发布', 5: '下架'}" :key="index" :label="Number(index)">{{item}}</el-radio><!-- , 1: '通过', 2: '待审核', 3: '驳回' -->
						</el-radio-group>
					</el-form-item>
					<el-form-item>
