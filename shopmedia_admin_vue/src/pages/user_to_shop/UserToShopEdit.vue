<template>
	<div class="user_to_shop_edit">
		<el-card class="main-card">
			<div slot="header" class="clearfix">
				<el-row :gutter="20" type="flex" justify="space-between">
					<el-col :span="6"><span>编辑店铺端业务员</span></el-col>
					<el-col :span="3">
			...
			<div class="">
				...
				<el-form ref="ruleForm" :model="form" :rules="rules" label-width="200px" size="small" class="demo-form-inline">
					...
					<el-form-item prop="auth_open_shop" label="授权开通店铺端" required>
						<el-radio-group v-model="form.auth_open_shop">
							<el-radio :label="1">允许</el-radio>
							<el-radio :label="0">禁止</el-radio>
						</el-radio-group>
					</el-form-item>
...
<script>
	export default {
		...
		methods: {
			...
			getUser() {
				let self = this;
				this.$axios.get(this.$url + 'user_to_shop/' + this.form.user_id, {
					/* headers: {
			...
			submitForm(formName) {
				...
				this.$refs[formName].validate((valid) => {
					if (valid) {
						this.$axios.put(this.$url + 'user_to_shop/' + this.form.user_id, {
							// 参数
							...
							auth_open_shop: this.form.auth_open_shop,
