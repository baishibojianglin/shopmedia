...
class Device extends Base
{
    ...
    {
        $result = $this->alias('d')
            ->field('d.device_id, d.brand, d.model, d.size, d.city_id, d.area_id, d.street_id, d.address, d.shopname, d.url_image, d.sale_price, d.saled_part, d.company_id, d.status, rc.region_name city, ra.region_name county, rs.region_name street, c.company_name, rp.region_name province')
