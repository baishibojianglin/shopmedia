...
class Ad extends Base
{
    ...
    {
        $result = $this->alias('a')
            ->field('a.ad_id, a.ad_cate_id, a.ad_name, a.ad_pic, a.start_datetime, a.end_datetime, a.start_time, a.end_time, a.play_times, a.ad_price, a.advertisers, a.phone, a.shop_cate_id, a.province_id, a.city_id, a.county_id, a.town_id, a.audit_id, a.audit_status, a.audit_time, a.is_show, a.sort, rp.region_name province, rc.region_name city, rco.region_name county, rt.region_name town')
