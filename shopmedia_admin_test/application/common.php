...
function sendSms($phone, $verifyCode){
    /*设置短信验证码*/
    AlibabaCloud::accessKeyClient('LTAI4GFM5A3zWki3CrfrkgwS', 'PEaYtoZPYkGGju36UUW74621mVqcKo')->regionId('cn-hangzhou')->asDefaultClient();
    try {
...
{
    // 阿里云RAM账号AccessKey
    $accessKeyId = "LTAI4GFM5A3zWki3CrfrkgwS";
    $accessKeySecret = "PEaYtoZPYkGGju36UUW74621mVqcKo";
    // Endpoint以成都为例，其它Region请按实际情况填写。
    $endpoint = "http://oss-cn-chengdu.aliyuncs.com";
    // 存储空间名称
    $bucket = "sustock-app-test";
    // 文件名称
